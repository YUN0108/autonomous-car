...
/* Private defines -----------------------------------------------------------*/
#define US_LEFT_TRIG_Pin GPIO_PIN_0
#define US_LEFT_TRIG_GPIO_Port GPIOC
#define US_CENTER_TRIG_Pin GPIO_PIN_1
#define US_CENTER_TRIG_GPIO_Port GPIOC
#define US_RIGHT_TRIG_Pin GPIO_PIN_2
#define US_RIGHT_TRIG_GPIO_Port GPIOC
#define US_LEFT_ECHO_Pin GPIO_PIN_6
#define US_LEFT_ECHO_GPIO_Port GPIOC
#define US_LEFT_ECHO_EXTI_IRQn EXTI9_5_IRQn
#define US_CENTER_ECHO_Pin GPIO_PIN_7
#define US_CENTER_ECHO_GPIO_Port GPIOC
#define US_CENTER_ECHO_EXTI_IRQn EXTI9_5_IRQn
#define US_RIGHT_ECHO_Pin GPIO_PIN_8
#define US_RIGHT_ECHO_GPIO_Port GPIOC
#define US_RIGHT_ECHO_EXTI_IRQn EXTI9_5_IRQn
